...
/**
 * source:
 * https://stackoverflow.com/questions/63144563/how-to-disable-global-cors-config-in-spring-cloud-gateway-yml-config-to-allow-r/63148481#63148481
 * */
@Configuration
public class CorsConfiguration {
    ...
    private static final String MAX_AGE = "3600"; //1 hour (1 * 60 * 60)


    @Bean
    public WebFilter corsFilter() {
        return (ServerWebExchange serverWebExchange, WebFilterChain chain) -> {
