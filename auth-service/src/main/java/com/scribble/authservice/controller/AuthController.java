...
public class AuthController {
        ...
        try {
            ...
            if(cognitoUserDetailsCustomResponse.getCognitoUserStatus().equals(CognitoUserStatus.FOUND)) {
                ...
                if(cognitoUserDetailsCustomResponse.getCognitoUserAccountStatus().equals(CognitoUserAccountStatus.CONFIRMED))
                    return ResponseEntity.status(400).body(new GenericAuthResponse(AuthErrorCode.BAD_REQUEST, "A user with this email already exists!"));
            }
            ...
            return ResponseEntity.status(200).body(new GenericAuthResponse(AuthErrorCode.SUCCESS, "Verification code sent!"));
            ...
            return ResponseEntity.status(500).body(new GenericAuthResponse(AuthErrorCode.INTERNAL_SERVER_ERROR, e.getErrorMessage()));
        }  catch (Exception e) {
            logger.error(e.getMessage());
            return ResponseEntity.status(500).body(new GenericAuthResponse(AuthErrorCode.INTERNAL_SERVER_ERROR, e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> confirmPasswordRequest(@Valid @RequestBody UserConfirmPasswordRequest userConfirmPasswordRequest) {
        ...
        try {
            ...
            if(confirmPasswordResult.getChallengeName().equals("NEW_PASSWORD_REQUIRED")){
                ...
                return ResponseEntity.status(200).body(new GenericAuthResponse(AuthErrorCode.SUCCESS, "SignUp complete"));
            }
            return ResponseEntity.status(500).body(new GenericAuthResponse(AuthErrorCode.INTERNAL_SERVER_ERROR, "Error signing in user"));
        } catch (AWSCognitoIdentityProviderException e) {
            /**
             * Base exception for all service exceptions thrown by Amazon Cognito Identity Provider
             * */
    ...
    public ResponseEntity<?> signInRequest(@Valid @RequestBody UserSignInRequest userSignInRequest){
        ...
        try {
            ...
            return ResponseEntity
                    ...
                    .body(new GenericAuthResponse(AuthErrorCode.SUCCESS, "User signed in."));
    ...
    public ResponseEntity<?> forgotPasswordRequest(@Valid @RequestBody UserSignUpOrForgotPasswordRequest userSignUpOrForgotPasswordRequest){
        ...
        try {
            ...
            return ResponseEntity.status(200).body(new GenericAuthResponse(AuthErrorCode.SUCCESS, "Verification code sent to your email"));
    ...
    public ResponseEntity<?> confirmForgotPassword(@Valid @RequestBody UserConfirmForgotPasswordRequest userConfirmForgotPasswordRequest){
        ...
        try {
            ...
            return ResponseEntity.status(200).body(new GenericAuthResponse(AuthErrorCode.SUCCESS, "Password reset successful"));
            ...
            logger.error(e.getMessage());
            return ResponseEntity.status(500).body(new GenericAuthResponse(AuthErrorCode.INTERNAL_SERVER_ERROR, "Error confirming new password"));
        }
    }
    ...
    public ResponseEntity<?> getNewTokensUsingRefreshToken(@RequestHeader("refresh_token") String refreshToken) {
        ...
        if(refreshToken == null || refreshToken.isEmpty())
            return ResponseEntity.status(400).body(new GenericAuthResponse(AuthErrorCode.BAD_REQUEST, "Refresh token missing from header"));
        ...
        try {
            ...
            ResponseCookie idTokenCookie = ResponseCookie.from("id_token", getNewTokensResult.getIdToken())
                    .httpOnly(true)
                    .build();
            return ResponseEntity.status(200).header(HttpHeaders.SET_COOKIE, idTokenCookie.toString()).body(new GenericAuthResponse(AuthErrorCode.SUCCESS, "success"));
        } catch (AWSCognitoIdentityProviderException e) {
            /**
             * Base exception for all service exceptions thrown by Amazon Cognito Identity Provider
             * */
    ...
    public ResponseEntity<?> userLogout(Authentication authentication) {
        ...
        if(email == null || email.isEmpty()){
            return ResponseEntity.status(500).body(new GenericAuthResponse(AuthErrorCode.INTERNAL_SERVER_ERROR, "Error parsing email from headers"));
        }
        try {
            // logout logic here
            /**
            ...
            return ResponseEntity.status(200).body(new GenericAuthResponse(AuthErrorCode.SUCCESS, "User logged out"));
        } catch (AWSCognitoIdentityProviderException e) {
            /**
             * Base exception for all service exceptions thrown by Amazon Cognito Identity Provider
             * */
            ...
            logger.error(e.getMessage());
            return ResponseEntity.status(500).body(new GenericAuthResponse(AuthErrorCode.INTERNAL_SERVER_ERROR, "Error logging out user"));
        }
    }
...
//        logger.info(authentication.);
            ...
            return ResponseEntity.status(200).body(new GenericAuthResponse(AuthErrorCode.SUCCESS, "Access granted! Hello " + authentication.getName()));
    }

    @GetMapping("/resource2")
    public ResponseEntity<?> getProtectedResource2() {
//        logger.info(authentication.);
        return ResponseEntity.status(200).body(new GenericAuthResponse(AuthErrorCode.SUCCESS, "Access granted 2!"));
    }

    @GetMapping("/test")
    public ResponseEntity<?> getTestResponse() {
        return ResponseEntity.status(200).body(new GenericAuthResponse(AuthErrorCode.SUCCESS, "Auth service is up!"));
    }
