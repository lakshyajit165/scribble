...
export class AddScribbleComponent implements OnInit {
  ...
  addScribble(): void {
    ...
    if (this.addScribbleFormGroup.valid) {
      this.addScribblePayload.title =
        this.addScribbleFormGroup.get('title')?.value ?? '';
      this.addScribblePayload.description =
        this.addScribbleFormGroup.get('description')?.value ?? '';
      this.addScribblePayload.label =
        this.addScribbleFormGroup.get('label')?.value ?? '';
      this.addScribblePayload.dueDate =
        this.addScribbleFormGroup.get('dueDate')?.value ?? '';
